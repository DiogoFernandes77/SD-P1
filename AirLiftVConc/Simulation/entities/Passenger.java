...
public class Passenger extends Thread{
    ...
    private void enterQueue(){
        ...
        DepartAirport.getInstance().enterQueue(id_passenger);
    }
    ...
    private void leaveThePlane(){ Plane.getInstance().leaveThePlane(id_passenger); }
    ...
    private void death(){
        ...
        DestAirport.getInstance().Passenger_death(id_passenger);
    }
